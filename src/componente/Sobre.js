      ...
      <section className="apresentacao__conteudo__Sobre">
        ...
        <img className="imagemSobre" src={Imagem} alt="" />
          <p>
            ...
            e tentando evoluir como profissional hoje tenho 42 anos e continuo
            estudando alias estou realizando meu sonho de ser um programador
            pretendo evoluir mais e mais nesta área para ser um profissional de
            excelência.
          </p>
          <p>
